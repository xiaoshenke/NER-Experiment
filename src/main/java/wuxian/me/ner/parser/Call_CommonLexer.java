...
public class Call_CommonLexer extends Lexer {
	...
	// delegates
	// delegators
	public CallLexer gCall;
	public CallLexer gParent;
	public Lexer[] getDelegates() {
		return new Lexer[] {};
	}

	public Call_CommonLexer() {} 
	public Call_CommonLexer(CharStream input, CallLexer gCall) {
		this(input, new RecognizerSharedState(), gCall);
	}
	public Call_CommonLexer(CharStream input, RecognizerSharedState state, CallLexer gCall) {
		super(input,state);
		this.gCall = gCall;
		gParent = gCall;
	}
